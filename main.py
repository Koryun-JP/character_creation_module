...
class Character:
    ...
    def defence(self):
        valur_defence = DEFAULT_DEFENCE + randint(*self.RANGE_VALUE_DEFENCE)
        return f'{self.name} блокировал {valur_defence} ед. урона.'
...
class Healer(Character):
    ...
    BRIEF_DESC_CHAR_CLASS = ('могущественный заклинатель. Черпает '
