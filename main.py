"""Модул для создания персонажа, тренеровки, атаки, защиты
и применения специального умения.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Функция возвращает сообщение о нанесенном уроне в зависимости
    от выбранного класса.
    ...
    Returns:
        str: текстовое сообщение о нанесенном уроне.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Функция возвращает сообщение о блокированном уроне в зависимости
    от выбранного класса.
    ...
    Returns:
        str: текстовое сообщение о блокированном уроне.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция возвращает сообщение о применении специального умения в
    зависимости от выбранного класса.
    ...
    Returns:
        str: тестовое сообщение о применении специального умения.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция для тренеровки умения атаковать, блокировать, использовать
    ...
    Returns:
        str: Возвращает текстовое сообщение о атаке, блокировке, использовании
        специального умения из соответствующих функции.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str | None:
    ...
    Returns:
        str | None: Возвращает класс персонажа
    """
    approve_choice = None
    char_class = None
